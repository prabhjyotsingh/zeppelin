...
public class ZeppelinIT extends AbstractZeppelinIT {
  ...
  public void testAngularRunParagraph() throws Exception {
    try {
      ...
      WebElement toggleEditor = driver.findElement(By.xpath(getParagraphXPath(2)
          + "//div[contains(@class, 'control')]//span[contains(@ng-click,'toggleEditor')]"));
      if (toggleEditor.getAttribute("class").equals("icon-size-fullscreen")) {
        toggleEditor.click();
      }
